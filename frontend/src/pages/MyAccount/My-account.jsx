            ...
            <div className="w-1/4 bg-white hidden lg:block flex flex-col text-gray-800 p-4 shadow-md rounded-lg ">
                <nav>
                    <ul>
                        ...
                        <li className="mb-4">
                            <Link to="/my/account" className="block py-2 px-4 bg-primary text-white rounded shadow-lg border-t border-gray-500">
                                Tài khoản của bạn
                            </Link>
                        </li>
                        <li className="mb-4">
            ...
            <div className="w-full lg:w-3/4 rounded-lg space-y-6">
                <div className="flex flex-col md:flex-row gap-2">
                    <div className="flex-1 bg-white p-10 shadow-md rounded-lg">
                        <h2 className="text-3xl font-bold mb-6">Thông tin tài khoản</h2>
                        ...
                        <div className="flex flex-col md:flex-row md:space-x-4 mb-4">
                            <div className="flex-1">
                                <label htmlFor="phone" class="block text-gray-700 font-semibold mb-2">Số điện thoại</label>
                                <input 
                                    type="tel" id="phone" 
                                    class="block w-full px-3 py-2 border border-gray-300 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" 
                    ...
                    <div className="flex-1 bg-white p-10 shadow-md rounded-lg">
                        ...
                        <form  id="changePasswordForm">
                            <div className="mb-4">
                                <label htmlFor="old-password" className="block text-gray-700 font-semibold mb-2">Mật khẩu cũ</label>
                                <input 
                                    type="password" 
                                    id="old-password" 
                            ...
                            <div className="mb-4">
                                <label htmlFor="new-password" className="block text-gray-700 font-semibold mb-2">Mật khẩu mới</label>
                                <input 
                                    type="password" 
                                    id="new-password" 
                            ...
                            <div className="mb-4">
                                <label htmlFor="auth-password" className="block text-gray-700 font-semibold mb-2">Xác nhận mật khẩu mới</label>
                                <input 
                                    type="password" 
                                    id="auth-password" 
                                    className="block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" 
