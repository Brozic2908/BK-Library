...
function History() {
  ...
  const getStatusColor = (trang_thai) => {
    switch (trang_thai) {
      ...
      case 'Chờ mượn': return 'text-sm px-3 py-1 font-medium rounded-full inline bg-gray-200 text-gray-700';
                            ...
                            <div className="flex flex-col justify-between md:flex-1 md:px-4">
                              <div className="flex">
                                <div>
                                  ...
                                  <p className="text-gray-600">Tác giả: <span className="font-medium text-gray-700">{order.tac_gia}</span></p>
