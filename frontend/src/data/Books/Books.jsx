import reactNativeImg from "../../assets/img/books/react_native_img.png";
import blockchainImg from "../../assets/img/books/blockchain_img_2.png";
import lamChuTiengAnhImg from "../../assets/img/books/lam_chu_kien_thuc_tieng_anh_img.png";
import wordImg from "../../assets/img/books/word_img.png";
import pythonImg from "../../assets/img/books/python_img.png";
import aiImg from "../../assets/img/books/AI_img.png";
import marketingImg from "../../assets/img/books/marketing_img.png";
import startupImg from "../../assets/img/books/starting_img.png";
import cleanCodeImg from "../../assets/img/books/clean_code.jpg";
import deepWorkImg from "../../assets/img/books/deepwork.png";
import powerOfHabitImg from "../../assets/img/books/powerofhabits.jpg";
import atomicHabitsImg from "../../assets/img/books/atomichabits.png";
import startWithWhyImg from "../../assets/img/books/startwithwhy.jpg";
export const books = [
  {
    id: 1,
...
Với khát vọng mong muốn giúp cho hàng triệu người Việt Nam có thể dễ dàng tiếp cận các kiến thức hữu ích, nâng cao năng lực sử dụng Word của bản thân từ đó giúp cho công việc tốt lên và cơ hội phát triển thăng tiến trong sự nghiệp.`,
  },
  {
    id: 5,
    title: "Python Cơ Bản và Nâng Cao",
    author: "Mark Lutz",
...
Cuốn sách được chia thành ba phần lớn. Phần đầu tiên mô tả các nguyên tắc, mô hình và cách thực hành viết mã sạch. Phần thứ hai gồm nhiều tình huống điển hình với mức độ phức tạp gia tang không ngừng. Mỗi tình huống là một bài tập giúp làm sạch mã, chuyển đổi mã có nhiều vấn đề thành mã có ít vấn đề hơn. Và phần cuối là tuyển tập rất nhiều những dấu hiệu của mã có vấn đề, những tìm tòi, suy nghiệm từ thực tiễn được đúc rút qua cách tình huống điển hình.`,
  ...
  {
    id: 11,
    title: "The Power of Habit - Sức mạnh của thói quen",
...
Và đó chính là sức mạnh của thói quen nguyên tử.`,
  ...
  {
    id: 13,
    title: "Start with Why - Bắt Đầu Với Câu Hỏi Tại Sao",
    author: "Simon Sinek",
    publisher: "NXB Công Thương",
    category: "Kinh doanh",
    publishedYear: 2024,
